...
function load {
    ...
    modifyWorkload "workloadUP2X"

    sed -i "s/\(workload: \)".*"/workload: \"workloadUP2X\"/" playbook-load.yaml
...
function flush {
    ...
    sed -i "s/\(workload: \)".*"/workload: \"workloadUP2X\"/" playbook-flush.yaml
