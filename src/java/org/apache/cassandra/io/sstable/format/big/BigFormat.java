...
public class BigFormat implements SSTableFormat {
    ...
    @Override
    public RowIndexEntry.IndexSerializer getIndexSerializer(TableMetadata metadata, Version version,
    ...
    static class BigVersion extends Version {
        ...
        // me (3.0.25, 3.11.11): added hostId of the node from which the sstable
        // originated

        // na (4.0-rc1): uncompressed chunks, pending repair session, isTransient,
         ...
         * swapped)
         * have no 'static' bits caused by using the same upper bits for both bloom
         * filter and token distribution.
         */
