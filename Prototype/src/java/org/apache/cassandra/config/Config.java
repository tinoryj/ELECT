...
public class Config {
    ...
    public volatile DurationSpec.IntMillisecondsBound permissions_validity = new DurationSpec.IntMillisecondsBound(
            "2s");
    ...
    public volatile DurationSpec.IntMillisecondsBound credentials_validity = new DurationSpec.IntMillisecondsBound(
            "2s");
    ...
    /**
     * Triggers automatic allocation of tokens if set, based on the provided replica
     * count for a datacenter
     */
    ...
    public DurationSpec.LongMillisecondsBound native_transport_idle_timeout = new DurationSpec.LongMillisecondsBound(
            "0ms");

    @Replaces(oldName = "request_timeout_in_ms", converter = Converters.MILLIS_DURATION_LONG, deprecated = true)
    public volatile DurationSpec.LongMillisecondsBound request_timeout = new DurationSpec.LongMillisecondsBound(
            "10000ms");

    @Replaces(oldName = "read_request_timeout_in_ms", converter = Converters.MILLIS_DURATION_LONG, deprecated = true)
    public volatile DurationSpec.LongMillisecondsBound read_request_timeout = new DurationSpec.LongMillisecondsBound(
            "5000ms");

    @Replaces(oldName = "range_request_timeout_in_ms", converter = Converters.MILLIS_DURATION_LONG, deprecated = true)
    public volatile DurationSpec.LongMillisecondsBound range_request_timeout = new DurationSpec.LongMillisecondsBound(
            "10000ms");

    @Replaces(oldName = "write_request_timeout_in_ms", converter = Converters.MILLIS_DURATION_LONG, deprecated = true)
    public volatile DurationSpec.LongMillisecondsBound write_request_timeout = new DurationSpec.LongMillisecondsBound(
            "2000ms");

    @Replaces(oldName = "counter_write_request_timeout_in_ms", converter = Converters.MILLIS_DURATION_LONG, deprecated = true)
    public volatile DurationSpec.LongMillisecondsBound counter_write_request_timeout = new DurationSpec.LongMillisecondsBound(
            "5000ms");

    @Replaces(oldName = "cas_contention_timeout_in_ms", converter = Converters.MILLIS_DURATION_LONG, deprecated = true)
    public volatile DurationSpec.LongMillisecondsBound cas_contention_timeout = new DurationSpec.LongMillisecondsBound(
            "1800ms");

    @Replaces(oldName = "truncate_request_timeout_in_ms", converter = Converters.MILLIS_DURATION_LONG, deprecated = true)
    public volatile DurationSpec.LongMillisecondsBound truncate_request_timeout = new DurationSpec.LongMillisecondsBound(
            "60000ms");

    @Replaces(oldName = "repair_request_timeout_in_ms", converter = Converters.MILLIS_DURATION_LONG, deprecated = true)
    public volatile DurationSpec.LongMillisecondsBound repair_request_timeout = new DurationSpec.LongMillisecondsBound(
            "120000ms");
    ...
    public volatile DurationSpec.LongMillisecondsBound slow_query_log_timeout = new DurationSpec.LongMillisecondsBound(
            "500ms");
    ...
    public int max_stripe_update_sstable = 8;
    ...
    public String cold_tier_ip;
    public int cold_tier_port = 8000;
    ...
    /*
     * RPC address and interface refer to the address/interface used for the native
     * protocol used to communicate with
     * clients. It's still called RPC in some places even though Thrift RPC is gone.
     * If you see references to native
    ...
    public DataStorageSpec.IntBytesBound internode_application_receive_queue_reserve_global_capacity = new DataStorageSpec.IntBytesBound(
            "512MiB");

    // Defensive settings for protecting Cassandra from true network partitions. See
    // (CASSANDRA-14358) for details.
    ...
    public volatile DurationSpec.IntMillisecondsBound internode_tcp_connect_timeout = new DurationSpec.IntMillisecondsBound(
            "2s");
    ...
    // high set this to 0
    // (which picks up the OS default) and configure the net.ipv4.tcp_retries2
    // sysctl to be ~8.
    @Replaces(oldName = "internode_tcp_user_timeout_in_ms", converter = Converters.MILLIS_DURATION_INT, deprecated = true)
    public volatile DurationSpec.IntMillisecondsBound internode_tcp_user_timeout = new DurationSpec.IntMillisecondsBound(
            "30s");
    // Similar to internode_tcp_user_timeout but used specifically for streaming
    // connection.
    // The default is 5 minutes. Increase it or set it to 0 in order to increase the
    // timeout.
    @Replaces(oldName = "internode_streaming_tcp_user_timeout_in_ms", converter = Converters.MILLIS_DURATION_INT, deprecated = true)
    public volatile DurationSpec.IntMillisecondsBound internode_streaming_tcp_user_timeout = new DurationSpec.IntMillisecondsBound(
            "300s"); // 5 minutes
    ...
    // Below 2 parameters were fixed in 4.0 + to get default value when ==-1 (old
    // name and value format) or ==null(new name and value format),
    ...
    public volatile DataStorageSpec.IntKibibytesBound column_index_size = new DataStorageSpec.IntKibibytesBound(
            "64KiB");
    @Replaces(oldName = "column_index_cache_size_in_kb", converter = Converters.KIBIBYTES_DATASTORAGE, deprecated = true)
    public volatile DataStorageSpec.IntKibibytesBound column_index_cache_size = new DataStorageSpec.IntKibibytesBound(
            "2KiB");
    @Replaces(oldName = "batch_size_warn_threshold_in_kb", converter = Converters.KIBIBYTES_DATASTORAGE, deprecated = true)
    public volatile DataStorageSpec.IntKibibytesBound batch_size_warn_threshold = new DataStorageSpec.IntKibibytesBound(
            "5KiB");
    @Replaces(oldName = "batch_size_fail_threshold_in_kb", converter = Converters.KIBIBYTES_DATASTORAGE, deprecated = true)
    public volatile DataStorageSpec.IntKibibytesBound batch_size_fail_threshold = new DataStorageSpec.IntKibibytesBound(
            "50KiB");
    ...
    public volatile DataRateSpec.LongBytesPerSecondBound compaction_throughput = new DataRateSpec.LongBytesPerSecondBound(
            "32MiB/s");
    ...
    public volatile DataStorageSpec.IntMebibytesBound compaction_large_partition_warning_threshold = new DataStorageSpec.IntMebibytesBound(
            "100MiB");
    ...
    public volatile DataRateSpec.LongBytesPerSecondBound stream_throughput_outbound = new DataRateSpec.LongBytesPerSecondBound(
            "24MiB/s");
    ...
    public volatile DataRateSpec.LongBytesPerSecondBound inter_dc_stream_throughput_outbound = new DataRateSpec.LongBytesPerSecondBound(
            "24MiB/s");

    public volatile DataRateSpec.LongBytesPerSecondBound entire_sstable_stream_throughput_outbound = new DataRateSpec.LongBytesPerSecondBound(
            "24MiB/s");
    public volatile DataRateSpec.LongBytesPerSecondBound entire_sstable_inter_dc_stream_throughput_outbound = new DataRateSpec.LongBytesPerSecondBound(
            "24MiB/s");
    ...
    /**
     * @deprecated since 4.0 This value was near useless, and we're not using it
     *             anymore
     */
    ...
    // storage.
    // When false, new CDC mutations can always be added. But it will remove the
    // oldest CDC commit log segment on full.
    ...
    public DurationSpec.IntMillisecondsBound cdc_free_space_check_interval = new DurationSpec.IntMillisecondsBound(
            "250ms");
    ...
    public DurationSpec.IntMillisecondsBound dynamic_snitch_update_interval = new DurationSpec.IntMillisecondsBound(
            "100ms");
    @Replaces(oldName = "dynamic_snitch_reset_interval_in_ms", converter = Converters.MILLIS_DURATION_INT, deprecated = true)
    public DurationSpec.IntMillisecondsBound dynamic_snitch_reset_interval = new DurationSpec.IntMillisecondsBound(
            "10m");
    ...
    public DataStorageSpec.IntKibibytesBound batchlog_replay_throttle = new DataStorageSpec.IntKibibytesBound(
            "1024KiB");
    ...
    public volatile DataStorageSpec.LongBytesBound max_hints_size_per_host = new DataStorageSpec.LongBytesBound("0B"); // 0
                                                                                                                       // means
                                                                                                                       // disabled
    ...
    public volatile DataStorageSpec.IntMebibytesBound sstable_preemptive_open_interval = new DataStorageSpec.IntMebibytesBound(
            "50MiB");
    ...
    /**
     * Because of the current {@link org.apache.cassandra.utils.memory.BufferPool}
     * slab sizes of 64 KiB, we
     * store in the file cache buffers that divide 64 KiB, so we need to round the
     * buffer sizes to powers of two.
     * This boolean controls weather they are rounded up or down. Set it to true to
     * round up to the
     * next power of two, set it to false to round down to the previous power of
     * two. Note that buffer sizes are
     * already rounded to 4 KiB and capped between 4 KiB minimum and 64 kb maximum
     * by the {@link DiskOptimizationStrategy}.
     * By default, this boolean is set to round down when
     * {@link #disk_optimization_strategy} is {@code ssd},
    ...
    public volatile DurationSpec.IntMinutesBound index_summary_resize_interval = new DurationSpec.IntMinutesBound(
            "60m");
     ...
     * security-manager!
     * By default, async UDF execution is enabled to be able to detect UDFs that run
     * too long / forever and be
     * able to fail fast - i.e. stop the Cassandra daemon, which is currently the
     * only appropriate approach to
     ...
     */
    // Below parameter is not presented in cassandra.yaml but to be on the safe side
    // that no one was directly using it
    ...
    /**
     * Set this to allow UDFs accessing java.lang.System.* methods, which basically
     * allows UDFs to execute any arbitrary code on the system.
     */
    public boolean allow_extra_insecure_udfs = false;

    /**
     * Time in milliseconds after a warning will be emitted to the log and to the
     * client that a UDF runs too long.
    ...
    public DurationSpec.LongMillisecondsBound user_defined_functions_warn_timeout = new DurationSpec.LongMillisecondsBound(
            "500ms");
    /**
     * Time in milliseconds after a fatal UDF run-time situation is detected and
     * action according to
     * user_function_timeout_policy will take place.
     * (Only valid, if user_defined_functions_threads_enabled==true)
     */
    @Replaces(oldName = "user_defined_function_fail_timeout", converter = Converters.MILLIS_DURATION_LONG, deprecated = true)
    public DurationSpec.LongMillisecondsBound user_defined_functions_fail_timeout = new DurationSpec.LongMillisecondsBound(
            "1500ms");
    /**
     ...
     * - 'die_immediate' - shut down C* daemon immediately (effectively prevent the
     * chance that the client will receive a warning).
     ...
     * is disconnected from all of them.
     ...
     * messages) before advertising to clients.
     * Due to this, by default, Casssandra will prime these internode TCP
     * connections and wait for all but a single
     * node to be DOWN/disconnected in the local datacenter before offering itself
     * as a coordinator, subject to a
     * timeout. See CASSANDRA-13993 and CASSANDRA-14297 for more details.
     *
     * We provide two tunables to control this behavior as some users may want to
     * block until all datacenters are
     * available (global QUORUM/EACH_QUORUM), some users may not want to block at
     * all (clients that already work
     * around the problem), and some users may want to prime the connections but not
     * delay startup.
     *
     * block_for_peers_timeout_in_secs: controls how long this node will wait to
     * connect to peers. To completely disable
     * any startup connectivity checks set this to -1. To trigger the internode
     * connections but immediately continue
     * startup, set this to to 0. The default is 10 seconds.
     *
     * block_for_peers_in_remote_dcs: controls if this node will consider remote
     * datacenters to wait for. The default
     ...
     * separate flags for range & single partition reads as single partition reads
     * are only tracked
     * when CL > 1 and a digest mismatch occurs. Currently, range queries don't use
     * digests so if
     * enabled for range reads, all such reads will include repaired data tracking.
     * As this adds
    ...
    /*
     * If true, unconfirmed mismatches (those which cannot be considered conclusive
     * proof of out of
     * sync repaired data due to the presence of pending repair sessions, or
     * unrepaired partition
     * deletes) will increment a metric, distinct from confirmed mismatches. If
     * false, unconfirmed
     * mismatches are simply ignored by the coordinator.
     * This is purely to allow operators to avoid potential signal:noise issues as
     * these types of
     * mismatches are considerably less actionable than their confirmed
     * counterparts. Setting this
     * to true only disables the incrementing of the counters when an unconfirmed
     * mismatch is found
    ...
    /*
     * If true, when a repaired data mismatch is detected at read time or during a
     * preview repair,
     * a snapshot request will be issued to each particpating replica. These are
     * limited at the replica level
     * so that only a single snapshot per-table per-day can be taken via this
     * method.
     */
    public volatile boolean snapshot_on_repaired_data_mismatch = false;

    /**
     * Number of seconds to set nowInSec into the future when performing validation
     * previews against repaired data
     * this (attempts) to prevent a race where validations on different machines are
     * started on different sides of
    ...
    public volatile DurationSpec.IntSecondsBound validation_preview_purge_head_start = new DurationSpec.IntSecondsBound(
            "3600s");

    public boolean auth_cache_warming_enabled = false;

    // Using String instead of ConsistencyLevel here to keep static initialization
    // from cascading and starting
    ...
    /**
     * This feature allows denying access to operations on certain key partitions,
     * intended for use by operators to
     * provide another tool to manage cluster health vs application access. See
     ...
     * growing unbounded. Operators will
     ...
     * Operators will receive warnings on initial cache load that there are too many
     * keys and be directed to trim
    ...
    /**
     * If true, when rows with duplicate clustering keys are detected during a read
     * or compaction
     * a snapshot will be taken. In the read case, each a snapshot request will be
     * issued to each
     * replica involved in the query, for compaction the snapshot will be created
     * locally.
     * These are limited at the replica level so that only a single snapshot per-day
     * can be taken
     * via this method.
     *
    ...
    public boolean autocompaction_on_startup_enabled = Boolean
            .parseBoolean(System.getProperty("cassandra.autocompaction_on_startup_enabled", "true"));
    ...
    /**
     * Client mode means that the process is a pure client, that uses C* code base
     * but does
     * not read or write local C* database files.
     *
     * @deprecated migrate to
     *             {@link DatabaseDescriptor#clientInitialization(boolean)}
     */
    @Deprecated
    ...
    public volatile DurationSpec.LongNanosecondsBound streaming_state_expires = new DurationSpec.LongNanosecondsBound(
            "3d");
    ...
    public volatile DurationSpec.LongNanosecondsBound repair_state_expires = new DurationSpec.LongNanosecondsBound(
            "3d");
    ...
    public enum PaxosVariant {
        /**
         * v1 Paxos lacks most optimisations. Expect 4RTs for a write and 2RTs for a
         * read.
         *
         * With legacy semantics for read/read and rejected write linearizability, i.e.
         * not guaranteed.
         */
        v1_without_linearizable_reads_or_rejected_writes,

        /**
         * v1 Paxos lacks most optimisations. Expect 4RTs for a write and 3RTs for a
         * read.
         */
        v1,
    ...
    /**
     * Select the kind of paxos state purging to use. Migration to repaired is
     * recommended, but requires that
     * regular paxos repairs are performed (which by default run as part of
     * incremental repair).
     *
     * Once migrated from legacy it is unsafe to return to legacy, but gc_grace mode
    ...
    public enum PaxosStatePurging {
        /**
         * system.paxos records are written and garbage collected with TTLs. Unsafe to
         * use with Commit consistency ANY.
         * Once migrated from, cannot be migrated back to safely. Must use gc_grace or
         * repaired instead, as TTLs
         * will not have been set.
         */
        legacy,

        /**
         * Functionally similar to legacy, but the gc_grace expiry is applied at
         * compaction and read time rather than
         * using TTLs, so may be safely enabled at any point.
         */
        gc_grace,

        /**
         * Clears system.paxos records only once they are known to be persisted to a
         * quorum of replica's base tables
         * through the use of paxos repair. Requires that regular paxos repairs are
         * performed on the cluster
         * (which by default are included in incremental repairs if paxos_variant = v2).
         *
         * This setting permits the use of Commit consistency ANY or LOCAL_QUORUM
         * without any loss of durability or consistency,
         * saving 1 RT.
         */
        repaired;
     ...
     * rare operation circumstances e.g. where for some reason the repair is
     * impossible to perform (e.g. too few replicas)
     * and an unsafe topology change must be made
     */
    public volatile boolean skip_paxos_repair_on_topology_change = Boolean
            .getBoolean("cassandra.skip_paxos_repair_on_topology_change");

    /**
     * A safety margin when purging paxos state information that has been safely
     * replicated to a quorum.
     * Data for transactions initiated within this grace period will not be
     * expunged.
     */
    public volatile DurationSpec.LongSecondsBound paxos_purge_grace_period = new DurationSpec.LongSecondsBound("60s");

    /**
     * A safety mechanism for detecting incorrect paxos state, that may be down
     * either to a bug or incorrect usage of LWTs
     * (most likely due to unsafe mixing of SERIAL and LOCAL_SERIAL operations), and
     * rejecting
     */
     ...
     *
     * Default is to ignore, as applications may readily mix SERIAL and LOCAL_SERIAL
     * and this is the most likely source
     * of linearizability violations. this facility should be activated only for
     * debugging Cassandra or by power users
    ...
    /**
     * Enable/disable paxos repair. This is a global flag that not only determines
     * default behaviour but overrides
     * explicit paxos repair requests, paxos repair on topology changes and paxos
     * auto repairs.
     */
    public volatile boolean paxos_repair_enabled = true;

    /**
     * If true, paxos topology change repair only requires a global quorum of live
     * nodes. If false,
     * it requires a global quorum as well as a local quorum for each dc
     * (EACH_QUORUM), with the
     * exception explained in paxos_topology_repair_strict_each_quorum
     */
    public boolean paxos_topology_repair_no_dc_checks = false;

    /**
     * If true, a quorum will be required for the global and local quorum checks. If
     * false, we will
     * accept a quorum OR n - 1 live nodes. This is to allow for topologies like
     * 2:2:2, where paxos queries
     * always use SERIAL, and a single node down in a dc should not preclude a paxos
     * repair
     */
    public boolean paxos_topology_repair_strict_each_quorum = false;

    /**
     * If necessary for operational purposes, permit certain keyspaces to be ignored
     * for paxos topology repairs
     */
    public volatile Set<String> skip_paxos_repair_on_topology_change_keyspaces = splitCommaDelimited(
            System.getProperty("cassandra.skip_paxos_repair_on_topology_change_keyspaces"));
    ...
    /**
     * The number of keys we may simultaneously attempt to finish incomplete paxos
     * operations for.
     */
    ...
    public volatile DataStorageSpec.LongBytesBound min_tracked_partition_size = new DataStorageSpec.LongBytesBound(
            "1MiB");
