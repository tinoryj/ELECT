...
UserName="tinoryj" # The user name of all the previous nodes
...
PathToArtifact="/home/${UserName}/Projects/ELECT" # The path to the artifact folder; we assume all the nodes have the same path.
