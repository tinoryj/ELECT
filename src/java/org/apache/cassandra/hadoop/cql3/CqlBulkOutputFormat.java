 ...
 * {@link org.apache.cassandra.hadoop.cql3.CqlOutputFormat},
...
public class CqlBulkOutputFormat extends OutputFormat<Object, List<ByteBuffer>>
    ...
    @Deprecated
    public CqlBulkRecordWriter getRecordWriter(FileSystem filesystem, JobConf job, String name, Progressable progress)
            throws IOException {
     ...
     * @throws IOException
     */
    public CqlBulkRecordWriter getRecordWriter(final TaskAttemptContext context)
    ...
    /** Fills the deprecated OutputFormat interface for streaming. */
    @Deprecated
    public void checkOutputSpecs(org.apache.hadoop.fs.FileSystem filesystem, org.apache.hadoop.mapred.JobConf job)
            throws IOException {
